...
- Since we don't get much from nmap, lets navigate to the actual 80_landing_page
...
- Clicking through the links i come across a page that allows you to upload
