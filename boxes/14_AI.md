...
```
and we have a possible username
...
- Lets look at the __JDWP__

- We begin by forwarding port 8000 using the ~C
...
```console
root@kali:/etc/apt/sources.list.d# jdb attach 8000
Picked up _JAVA_OPTIONS: -Dawt.useSystemAAFontSettings=on -Dswing.aatext=true
Initializing jdb ...
> 
```

- And we get a shell, you can run a bunch of stuff here, this is something you have to research about.
